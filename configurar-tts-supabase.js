...
async function configurarTTSSupabase() {
  try {
    console.log('🎤 Configurando Google TTS com credenciais do Supabase...\n');

    // 1. Verificar se existe GOOGLE_AI_API_KEY
    console.log('1. Verificando chave do Google AI...');
    
    // Testar com a chave do Google AI que já existe
    ...
    if (testResponse.ok) {
      ...
      if (response.ok) {
        ...
        console.log('\n🎤 A Sofia agora terá voz natural usando as credenciais do Supabase!');
      ...
      // Tentar criar uma nova chave usando as credenciais do Supabase
      console.log('\n🔄 Tentando configurar nova chave...');
      console.log('💡 Você precisa:');
      console.log('1. Acessar: https://console.cloud.google.com/');
      console.log('2. Ativar a API "Cloud Text-to-Speech"');
      console.log('3. Criar uma nova chave de API');
      console.log('4. Executar: node configurar-tts-rapido.js');
    }
    
  } catch (error) {
    console.error('❌ Erro na configuração:', error);
    console.log('\n💡 Solução alternativa:');
    console.log('1. Execute: node configurar-tts-rapido.js');
    console.log('2. Siga as instruções para criar nova chave');
  }
}

// Executar configuração
configurarTTSSupabase();
