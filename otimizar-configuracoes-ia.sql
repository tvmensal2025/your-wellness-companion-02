-- Otimizar configurações de IA para usar Gemini Pro com menos tokens
-- e adicionar informações do Instituto dos Sonhos

-- 1. Atualizar configurações de IA para usar Gemini Pro com menos tokens
UPDATE ai_configurations SET
  service = 'gemini',
  model = 'gemini-1.5-pro',
  max_tokens = 1024,  -- Reduzido de 2000 para 1024
  temperature = 0.7,
  preset_level = 'minimo',
  level = 'minimo',
  updated_at = NOW()
