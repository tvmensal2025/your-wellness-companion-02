...
-- Trigger para automaticamente adicionar entrada no histórico
CREATE OR REPLACE FUNCTION public.add_to_measurement_history()
RETURNS TRIGGER AS $$
BEGIN
  INSERT INTO public.historico_medidas (user_id, peso_kg, circunferencia_abdominal_cm, altura_cm, imc, data_medicao)
  VALUES (NEW.user_id, NEW.peso_atual_kg, NEW.circunferencia_abdominal_cm, NEW.altura_cm, NEW.imc, CURRENT_DATE)
