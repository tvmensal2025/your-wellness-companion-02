...
-- Verificar e corrigir a tabela user_anamnesis com todas as colunas necessárias
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'user_anamnesis' AND policyname = 'Users can view their own anamnesis') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'user_anamnesis' AND policyname = 'Users can create their own anamnesis') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'user_anamnesis' AND policyname = 'Users can update their own anamnesis') THEN
