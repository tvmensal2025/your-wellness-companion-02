-- Criar tabelas de tracking sem usar IF NOT EXISTS em policies
...
-- Políticas RLS para water_tracking (drop se existir e recriar)
DROP POLICY IF EXISTS "Users can view their own water tracking" ON public.water_tracking;
CREATE POLICY "Users can view their own water tracking" 
ON public.water_tracking 
FOR SELECT 
USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can insert their own water tracking" ON public.water_tracking;
CREATE POLICY "Users can insert their own water tracking" 
ON public.water_tracking 
FOR INSERT 
WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can update their own water tracking" ON public.water_tracking;
...
DROP POLICY IF EXISTS "Users can view their own mood tracking" ON public.mood_tracking;
CREATE POLICY "Users can view their own mood tracking" 
ON public.mood_tracking 
FOR SELECT 
USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can insert their own mood tracking" ON public.mood_tracking;
CREATE POLICY "Users can insert their own mood tracking" 
ON public.mood_tracking 
FOR INSERT 
WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can update their own mood tracking" ON public.mood_tracking;
