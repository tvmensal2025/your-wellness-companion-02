-- =====================================================
-- ADICIONAR DISPLAY_MODE PARA DESAFIOS
-- Admin pode escolher onde o desafio aparece:
-- 'normal' = Aba de desafios (padrão)
-- 'featured' = Popup/Alerta (sino)
-- 'flash' = Desafio relâmpago com timer
-- =====================================================
