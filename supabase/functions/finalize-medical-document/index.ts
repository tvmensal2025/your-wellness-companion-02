...
async function analyzeAndProcessExam(
  ...
  try {
    ...
    const systemPrompt = `Você é o Dr. Vital, IA médica da MaxNutrition. Analise os exames médicos nas imagens e gere um relatório claro e didático em português brasileiro.
