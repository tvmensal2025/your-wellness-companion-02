-- ========================================
-- INSERIR DADOS NUTRICIONAIS MEDICINAIS
-- BASE ROBUSTA DA SOFIA
-- "FAÇA DE SEU ALIMENTO SEU REMÉDIO"
-- ========================================

-- 1. INSERIR ALIMENTOS MEDICINAIS COMPLETOS
...
-- 2. INSERIR VALORES NUTRICIONAIS COMPLETOS
...
-- Chia
(16, 16.5, 42.1, 30.7, 3.3, 27.4, 34.4, 486, 1, 1.6, 0.6, 0.9, 631.0, 7.7, 335.0, 407.0, 4.6, 17.8, 5.8, 0.85, 85),

-- Linhaça
(17, 18.3, 28.9, 42.2, 3.7, 38.5, 27.3, 534, 1, 0.6, 0.5, 0.9, 255.0, 5.7, 392.0, 813.0, 4.3, 22.8, 5.9, 0.80, 80),

-- Amêndoas
(18, 21.2, 21.7, 49.9, 3.8, 46.1, 12.5, 579, 0, 0.0, 0.2, 0.1, 269.0, 3.7, 270.0, 733.0, 3.1, 0.0, 12.1, 0.75, 75),

-- Iogurte Natural
(19, 3.5, 4.7, 3.3, 2.1, 1.2, 0.0, 59, 14, 0.5, 0.0, 0.1, 121.0, 0.1, 12.0, 155.0, 0.6, 0.0, 0.1, 0.85, 85),

-- Queijo Cottage
(20, 11.1, 3.4, 4.3, 2.7, 1.6, 0.0, 98, 10, 0.0, 0.0, 0.1, 83.0, 0.1, 8.0, 104.0, 0.4, 0.0, 0.1, 0.90, 90),

-- Gengibre
(21, 1.8, 17.8, 0.8, 0.2, 0.6, 2.0, 80, 15, 5.0, 0.0, 0.2, 16.0, 0.6, 43.0, 415.0, 0.3, 0.0, 0.1, 0.40, 40),

-- Cúrcuma
(22, 8.0, 65.0, 10.0, 3.1, 6.9, 21.0, 354, 0, 25.9, 0.1, 0.1, 168.0, 55.0, 208.0, 2080.0, 4.5, 0.0, 0.1, 0.50, 50),

-- Alho
(23, 6.4, 33.1, 0.5, 0.1, 0.4, 2.1, 149, 30, 31.2, 0.2, 1.2, 181.0, 1.7, 25.0, 401.0, 1.2, 0.0, 0.1, 0.60, 60);

-- 3. INSERIR DOENÇAS E CONDIÇÕES
...
-- 4. INSERIR SUBSTITUIÇÕES INTELIGENTES
...
-- 5. INSERIR COMBINAÇÕES TERAPÊUTICAS
...
SELECT '✅ DADOS NUTRICIONAIS MEDICINAIS INSERIDOS!' as status;
