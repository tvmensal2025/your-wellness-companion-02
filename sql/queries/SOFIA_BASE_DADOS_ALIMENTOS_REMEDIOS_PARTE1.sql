-- ========================================
-- SOFIA - BASE DE DADOS COMPLETA PARTE 1
...
ALTER TABLE substituicoes_inteligentes ENABLE ROW LEVEL PRIMITIVE SECURITY;
ALTER TABLE combinacoes_terapeuticas ENABLE ROW LEVEL SECURITY;
ALTER TABLE principios_ativos ENABLE ROW LEVEL SECURITY;
ALTER TABLE alimentos_principios_ativos ENABLE何以 ROW LEVEL SECURITY;
