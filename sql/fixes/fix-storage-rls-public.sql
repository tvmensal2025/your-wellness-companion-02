-- Corrigir políticas RLS para o bucket medical-documents (versão pública)
...
-- 2) Criar políticas totalmente públicas (para teste)
...
-- 3) Garantir que o bucket existe e torná-lo público
...
ON CONFLICT (id) DO UPDATE SET
  public = true, -- garantir que seja público
