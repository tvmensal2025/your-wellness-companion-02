      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8">
          <div className="space-y-4 sm:space-y-6">
            ...
            {/* Score Geral - Primeiro no Mobile */}
            <Card className="shadow-lg border-0 bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
              <CardHeader className="text-center pb-2 sm:pb-4 bg-gradient-to-r from-green-600/20 to-blue-600/20 rounded-t-lg p-3 sm:p-6">
              ...
              <CardContent className="p-3 sm:p-6">
                ...
                <div className="bg-black/30 rounded-lg p-4 sm:p-8">
                  <div className="text-center">
                    <div className="relative mb-4">
                      <svg viewBox="0 0 300 180" className="w-full max-w-[280px] sm:max-w-[300px] mx-auto">
                        <defs>
            ...
            {/* Roda da Vida/Saúde */}
            <Card className="shadow-lg border-0 bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800 overflow-hidden">
              <CardHeader className="text-center pb-2 sm:pb-4 bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-t-lg p-3 sm:p-6">
                <CardTitle className="text-white flex items-center justify-center gap-2 text-base sm:text-lg">
            ...
            <Card className="border-gray-200 dark:border-gray-700">
              ...
              <CardContent className="p-3 sm:p-6 pt-0">
                <div className="grid gap-2 sm:gap-4 grid-cols-3">
                  <div className="text-center p-2 sm:p-4 rounded-lg bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-800">
                    <div className="text-lg sm:text-2xl font-bold text-red-600 dark:text-red-400">0-40%</div>
                    <div className="text-xs sm:text-sm text-red-700 dark:text-red-300">Crítico</div>
                  </div>
                  <div className="text-center p-2 sm:p-4 rounded-lg bg-yellow-50 dark:bg-yellow-950 border border-yellow-200 dark:border-yellow-800">
                    <div className="text-lg sm:text-2xl font-bold text-yellow-600 dark:text-yellow-400">41-70%</div>
                    <div className="text-xs sm:text-sm text-yellow-700 dark:text-yellow-300">Atenção</div>
                  </div>
                  <div className="text-center p-2 sm:p-4 rounded-lg bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800">
                    <div className="text-lg sm:text-2xl font-bold text-green-600 dark:text-green-400">71-100%</div>
                    <div className="text-xs sm:text-sm text-green-700 dark:text-green-300">Excelente</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2">
              <Card className="border-blue-200 bg-gradient-to-br from-blue-50 to-cyan-50 dark:border-blue-800 dark:from-blue-950 dark:to-cyan-950 shadow-lg">
                <CardHeader className="pb-2 p-3 sm:p-6">
                  <CardTitle className="text-blue-800 dark:text-blue-200 text-sm sm:text-base flex items-center gap-2">
                ...
                <CardContent className="p-3 sm:p-6 pt-0">
                  <p className="text-xs sm:text-sm text-blue-700 dark:text-blue-300 leading-relaxed">
                    {content.areas 
                      ? 'Avaliação do seu equilíbrio de vida.'
                      : 'Avaliação dos principais sistemas do corpo.'
                    }
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-green-200 bg-gradient-to-br from-green-50 to-emerald-50 dark:border-green-800 dark:from-green-950 dark:to-emerald-950 shadow-lg">
                <CardHeader className="pb-2 p-3 sm:p-6">
                  <CardTitle className="text-green-800 dark:text-green-200 text-sm sm:text-base flex items-center gap-2">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center mt-4">
              ...
              <Button variant="outline" size="lg" onClick={() => window.print()} className="w-full sm:w-auto">
                📄 Imprimir
              </Button>
            </div>
          </div>
