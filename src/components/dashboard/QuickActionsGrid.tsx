...
export const QuickActionsGrid: React.FC<QuickActionsGridProps> = ({
  ...
  return <div className="space-y-3 sm:space-y-4">
      ...
      scale: 0.98
    }} onClick={onWeightClick} className="w-full flex items-center justify-between p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-600 shadow-emerald-500/20 shadow-lg text-white">
