        ...
        <div className="flex items-stretch gap-3 sm:gap-5">
          ...
          <div className="relative flex-shrink-0 flex items-center justify-center">
            <svg className="w-24 h-24 sm:w-32 md:w-36 sm:h-32 md:h-36 -rotate-90" viewBox="0 0 100 100">
              ...
              {/* Progress ring */}
              <motion.circle cx="50" cy="50" r="42" fill="none" stroke="url(#healthGradient)" strokeWidth="8" strokeLinecap="round" strokeDasharray={2 * Math.PI * 42} initial={{
              strokeDashoffset: 2 * Math.PI * 42
            }} animate={{
              strokeDashoffset: 2 * Math.PI * 42 - ringPercentage / 100 * 2 * Math.PI * 42
            }} transition={{
              duration: 1.5,
              ease: [0.22, 1, 0.36, 1]
            }} />
          ...
          <div className="flex-1 flex-col space-y-2 sm:space-y-3 min-w-0 flex items-center justify-center">
            ...
            delay: 0.5
              ...
              {currentWeight === 0 ? <span className="text-sm sm:text-base font-medium text-primary">
            ...
            {/* Goal info */}
            {targetWeight && <div className="flex items-center gap-2 sm:gap-2.5 text-xs sm:text-sm text-slate-400 mt-1 sm:mt-1.5 flex-wrap">
