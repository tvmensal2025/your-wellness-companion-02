...
interface DraggableScoreDashboardProps {
  totalScore: number;
  areas: AreaData[];
...
export const DraggableScoreDashboard: React.FC<DraggableScoreDashboardProps> = ({
  totalScore,
  areas,
  otherAreasCount = 0,
  className = ""
  ...
  return (
    <div className={`relative min-h-screen ${className}`}>
      ...
      <motion.div 
        drag
        dragMomentum={false}
        className="absolute top-0 left-0 w-[400px] cursor-move"
        whileDrag={{ scale: 1.05, zIndex: 50 }}
      >
        <div className="bg-gray-800/20 p-2 rounded-t-lg">
      ...
      <motion.div 
        drag
        dragMomentum={false}
        className="absolute top-0 right-0 w-[400px] cursor-move"
        whileDrag={{ scale: 1.05, zIndex: 50 }}
      >
        <div className="bg-gray-800/20 p-2 rounded-t-lg">
          <span className="text-xs text-gray-400">📋 Arrastar para mover</span>
...
export default DraggableScoreDashboard; 