...
export const ExerciseDetailModal: React.FC<ExerciseDetailModalProps> = ({
  ...
  const exerciseList = location === 'casa' ? Object.entries(exerciseInstructions.casa) : Object.entries(exerciseInstructions.academia);
  ...
  const renderVideoBlock = () => {
    ...
    return <div className="rounded-xl overflow-hidden bg-black/80">
        {videoId ? <div className="relative w-full pt-[50%]">
            <iframe className="absolute inset-0 w-full h-full" src={`https://www.youtube.com/embed/${videoId}`} title="Vídeo do exercício" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen />
          </div> : <div className="flex items-center justify-center min-h-[200px] bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-950 dark:to-red-950">
  ...
  const renderOverview = () => {
    ...
    return <div className="space-y-4">
        ...
        <div className="flex justify-between gap-2 mt-2">
          ...
          <Button className="flex-1 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 py-2" onClick={startExecution}>
  ...
  const renderInstructions = () => {
    ...
    return <div className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="space-y-2">
              {exerciseDetails.passos.map((passo: string, index: number) => <div key={index} className="flex items-start gap-2 bg-white/50 dark:bg-black/20 p-3 rounded-lg">
        ...
        <Button className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600" onClick={startExecution}>
        ...
        <Card className="bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-950 dark:to-red-950 border border-orange-200 dark:border-orange-800">
          <CardContent className="p-3 text-center space-y-2">
            ...
            <div className="flex gap-2 justify-center">
              <Button size="sm" onClick={toggleTimer} className="px-3 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600">
                {isTimerRunning ? <>
        ...
        <DialogHeader>
          <DialogTitle className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <Button variant="outline" size="icon" onClick={prevExercise} className="h-10 w-10">
                
              </Button>
              <Button variant="outline" size="icon" onClick={nextExercise} className="h-10 w-10">
