  ...
  return (
    ...
    >
      <div className="flex items-center h-10 px-4">
        ...
        {/* Title - Centered */}
        <div className="flex-1 flex items-center justify-center min-w-0 px-1 max-w-[60%]">
        ...
        <div className="flex items-center gap-3 shrink-0 min-w-[72px] justify-end">
          ...
          <button
            ...
            className="h-7 w-7 rounded-full transition-all touch-manipulation active:scale-95"
