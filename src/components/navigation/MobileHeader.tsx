              ...
              <SheetTrigger asChild>
                <button 
                  className={cn(
                    ...
                    "hover:bg-primary/10 transition-colors touch-target"
                  )}
                  aria-label="Escolher cor do app"
                >
              ...
              <SheetContent side="bottom" className="rounded-t-3xl pb-8">
                ...
                <div className="grid grid-cols-4 gap-4 px-2">
                  {THEME_PRESETS.map((preset, index) => (
                    ...
                    >
                      <div className={cn(
                        "w-14 h-14 rounded-2xl transition-all duration-200 flex items-center justify-center",
                        `bg-gradient-to-br ${preset.gradient}`,
                        "shadow-lg",
                        currentPreset.id === preset.id 
                          ? "ring-3 ring-white ring-offset-2 ring-offset-background scale-105" 
                      ...
                      <span className={cn(
                        ...
                        currentPreset.id === preset.id ? "text-primary" : "text-muted-foreground"
                      )}>
                        {preset.name}
                      </span>
                    </motion.button>
