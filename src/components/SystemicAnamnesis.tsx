...
const SystemicAnamnesis = () => {
  ...
  return (
    <div className="min-h-screen bg-background py-4 sm:py-8 pb-24">
            ...
            <CardDescription className="text-muted-foreground text-sm sm:text-base lg:text-lg">
              ...
              {hasExistingAnamnesis && (
                <div className="mt-2 text-xs sm:text-sm">
                  <span className="bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 px-2 py-1 rounded-md inline-block">
              ...
              {isDraft && !hasExistingAnamnesis && (
                <div className="mt-2 text-xs sm:text-sm">
                  <span className="bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 px-2 py-1 rounded-md inline-block">
                    📝 Rascunho
                  </span>
                </div>
              )}
          ...
          <CardContent className="px-3 sm:px-6 pb-4 sm:pb-6">
            <form onSubmit={handleSubmit}>
              <div className="mb-6 sm:mb-8">
                ...
                <div className="bg-card p-3 sm:p-6 rounded-lg border border-border">
                  {sections[currentSection].fields}
                </div>
              </div>

              {/* Navigation Buttons - Mobile Fixed Bottom */}
              <div className="fixed bottom-0 left-0 right-0 bg-card border-t border-border p-3 sm:p-4 flex justify-between gap-2 sm:relative sm:bg-transparent sm:border-0 sm:p-0 z-40">
                <Button
                  type="button"
                  variant="outline"
                  onClick={prevSection}
                ...
                {currentSection === sections.length - 1 ? (
                  <Button
                    ...
                    disabled={loading}
                    className="flex-1 sm:flex-none px-3 sm:px-8 text-sm sm:text-base"
                  >
