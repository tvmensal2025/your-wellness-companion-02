-- ATRIBUIR SESSÕES PARA TODOS OS USUÁRIOS
...
-- 5. Atribuir todas as sessões ativas a todos os usuários
...
-- 6. Verificar atribuições criadas
SELECT 
  'Atribuições criadas:' as info,
  COUNT(*) as total
FROM user_sessions;

-- 7. Mostrar detalhes das atribuições por usuário
SELECT 
...
-- 8. Mostrar algumas atribuições de exemplo
SELECT 
