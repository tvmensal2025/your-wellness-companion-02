...
async function criarDesafiosLimpos() {
  console.log('🧹 Criando desafios limpos e organizados...');

  try {
    // Primeiro, vamos limpar desafios antigos com nomes estranhos
    ...
    if (deleteError) {
      console.log('❌ Erro ao limpar desafios antigos:', deleteError.message);
    } else {
      console.log('✅ Desafios antigos removidos');
    }

    // Desafios Individuais Limpos
    ...
    const desafiosPublicos = [
      ...
      },
      {
        ...
        instructions: 'Medite 15 minutos por dia e compartilhe suas reflexões com a comunidade.',
        tips: ['Mesmo horário todos os dias', 'Local silencioso', 'Apps de meditação guiada'],
        is_active: true,
        is_featured: false,
        is_group_challenge: true,
        daily_log_target: 15,
      ...
      },
      {
        ...
        instructions: 'Complete 4 metas diárias: água, exercício, alimentação e sono. Para os verdadeiros campeões!',
        tips: ['Planeje com antecedência', 'Use checklist', 'Celebre pequenas vitórias'],
        is_active: true,
        is_featured: true,
        is_group_challenge: true,
        daily_log_target: 4,
    ...
    // Inserir desafios individuais
    console.log('📊 Inserindo desafios individuais...');
    ...
    // Inserir desafios públicos
    console.log('👥 Inserindo desafios públicos...');
