-- LIMPAR TUDO e desabilitar RLS
-- Remove todas as políticas primeiro, depois desabilita RLS

-- 1. REMOVER TODAS as políticas existentes (força a remoção)
...
-- 7. RESULTADO
SELECT 'TUDO LIMPO E RLS DESABILITADO!' as status,
       'Agora teste criar um curso' as resultado; 