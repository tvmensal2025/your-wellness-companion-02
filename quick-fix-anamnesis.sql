-- Script rápido para corrigir a tabela user_anamnesis
...
ADD COLUMN IF NOT EXISTS chronic_diseases JSONB DEFAULT '[]',
...
ADD COLUMN IF NOT EXISTS previous_weight_treatments JSONB DEFAULT '[]',
...
ADD COLUMN IF NOT EXISTS herbal_medicines JSONB DEFAULT '[]',
...
ADD COLUMN IF NOT EXISTS problematic_foods JSONB DEFAULT '[]',
ADD COLUMN IF NOT EXISTS forbidden_foods JSONB DEFAULT '[]',
...
AND column_name IN ('city_state', 'biggest_weight_loss_challenge', 'chronic_diseases')
